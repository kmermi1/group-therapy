...
export default function NewPlanForm({ today }: { today: string }) {
  const [schedule, setSchedule] = useState<"progressing" | "repeating">("progressing");
      ...
      <Card className="space-y-3">
        ...
        <div>
          ...
          <select
            ...
            name="schedule"
            value={schedule}
            onChange={(e) => setSchedule(e.target.value as "progressing" | "repeating")}
      ...
      <Card className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-[var(--color-foreground)]/60 mt-1">Smallest chunk a member can claim. e.g. 5 for Jawshan blocks.</p>
          </div>
        </div>
      </Card>
