...
const en = {
  ...
  sectionAssignedToYouDesc: "Picked by the admin just for you",
  sectionGroupTasksDesc: "Everyone in your group has these",
  sectionPersonalDesc: "Private — only visible to you",
  sectionLongTermDesc: "Multi-week goals — counts toward your all-time total",
  sectionReadingPlansDesc: "Long-running shared reading plans",
  badgeForYou: "For you",
  badgeGroup: "Group",
...
const tr: Partial<typeof en> = {
  ...
  sectionAssignedToYouDesc: "Yönetici tarafından sana özel atandı",
  sectionGroupTasksDesc: "Gruptaki herkes bunlardan sorumlu",
  sectionPersonalDesc: "Özel — sadece sen görürsün",
  sectionLongTermDesc: "Çok haftalık hedefler — tüm zamanlar toplamına sayılır",
  sectionReadingPlansDesc: "Uzun süren ortak okuma planları",
  badgeForYou: "Sana",
  badgeGroup: "Grup",
